...
//
//################################################################################
// Abrir o terminal e rodar o seguinte comando para instalar a biblioteca necessária:
...
//########################################################################################################################
//COLAR AQUI O ENDPOINT E A CHAVE DE API ENCONTRADO NO GERENCIAMENTO DE CHAVE DO SERVIÇO CRIADO
//const endpoint = process.env["ENDPOINT"] || "<cognitive services endpoint>";
//const apiKey = process.env["TEXT_ANALYTICS_API_KEY"] || "<api key>";

const endpoint = process.env["ENDPOINT"] || "https://sentimentowagner502.cognitiveservices.azure.com/";
const apiKey = process.env["TEXT_ANALYTICS_API_KEY"] || "c9917c8fef3f4f6a83a1ef1f9942376f";
